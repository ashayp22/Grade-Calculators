...
function campusCalc() {
    var before = document.getElementById('userGrade').value;
    before = parseInt(before, 10);
    var percent = 100 - ((100 - before) / 2);
    document.getElementById("percentGrade").innerHTML = "Actual Percent Grade: " + percent + "%";
}
